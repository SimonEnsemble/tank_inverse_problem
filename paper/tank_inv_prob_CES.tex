...
Liquid shape scanning:
 inferring the horizontal cross-sectional area profile of a solid contained in a tank from liquid level dynamics as it drains 
...
(i) is defined as the ratio of the observed outlet volumetric flow rate to that predicted by Torricelli's law together with the area of the orifice under the assumption of plug flow for the exiting jet \cite{hicks2014determining};
(ii) accounts for 
...
(a) horizontal cross-sectional area profile of the tank from (b) the liquid level as a function of time. (The rate of decrease of the liquid level provides information about the area of the horizontal cross-section of the tank at that height. The outlet flow rate depends on the \emph{height} of water in the tank, not the girth; so, wider [say, cylindrical] tanks drain more slowly.)
...
Herein, we employ Bayesian statistical inversion \cite{calvetti2018inverse,waqar2023tutorial,kaipio2006statistical,dashti2013bayesian} to solve, with quantified uncertainty, an inverse problem of reconstruction (or, ``seeing the unseen'' \cite{uhlmann2014inverse}): infer the horizontal cross-sectional area profile of an exogenous solid (of unknown geometry) contained in a draining tank (of known geometry) from measurements of the liquid level in the draining tank over time. 
(We assume the solid is heavy and incapable of holding water itself.)
Because the solid displaces liquid in the tank, the rate of decrease of the liquid level provides information about the area of the horizontal cross-section of the solid at the height of the liquid.
...
when a small parcel of water, of mass $\Delta m$, travels from the surface of the liquid in the tank to just outside of the orifice.

...
% Address/affiliation
\affiliation[1]{organization={Oregon State University, School of Chemical, Biological, and Environmental Engineering},
            % addressline={}, 
            city={Corvallis},
...
% TODO mention future work syrup
...
Torricelli's law matches the gain in kinetic energy $m v^2/2$ of a small parcel of water, of mass $m$, that travels along this streamline from the surface of the liquid in the tank to just outside of the orifice, with its loss in gravitational potential energy $m g(h-h_o)$.
...
\end{equation}
The discharge coefficient is intended to account for the inter-related non-plug flow through the orifice and vena contracta in the water jet as well as frictional losses
...
Adrian Henle for feedback on our manuscript; Axel Rodriguez for help articulating the condition for a solid to be incapable of holding water; and the reviewers for their feedback that led to improvements.

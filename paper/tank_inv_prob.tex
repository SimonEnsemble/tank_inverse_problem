...
Our approach may be practically useful to infer the shape of an unknown solid, or the porosity of packed solid particles, inside of an opaque tank giving access to liquid level measurements. 
\newline
...
The exogenous solid (i) is heavier than water, and thus remains stationary at the bottom of the tank, and (ii) displaces water in the tank.
...
Our methodology herein could be employed throughout engineering and the applied sciences to infer the shape of an exogenous solid inside of an opaque liquid-holding tank, provided we have access to liquid level measurements.
In a similar manner, one could infer the height and/or porosity of small, heavy solid particles (e.g. gravel, sand) packed into a liquid holding tank as well.
...
(c) additional inputs/outputs of liquid by adding source/sink terms, and/or
(d) Mariotte's bottle \cite{kirevs2006mariotte}.
...
\ack{CMS acknowledges Intel for funding. GF acknowledges ARMI for funding. Thanks Brian Wood for helpful discussions about the possibility to infer the precise shape of the solid in the tank by tilting it.}

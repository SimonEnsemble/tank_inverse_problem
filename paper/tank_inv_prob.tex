...
Comparing with our [more] direct (via a tape measure) measurements of the solid's area as a function of height, the inferred area of the solid traces its shape reasonably well ($\sim$10\% mean reconstruction error on the bottle's radius). 

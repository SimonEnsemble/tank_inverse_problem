...
Herein, we employ Bayesian statistical inversion \cite{calvetti2018inverse,waqar2023tutorial,kaipio2006statistical,dashti2013bayesian} to solve the following inverse problem of reconstruction with quantified uncertainty: infer the shape of an exogenous, heavy, convex solid (of unknown geometry) contained in a draining tank (of known geometry) from measurements of its liquid level over time.
...
The exogenous [rigid] solid (i) is heavier than water, and thus remains stationary at the bottom of the tank; (ii) displaces water in the tank; and (iii) has a convex geometry so it cannot contain water itself. 
...
Another interesting route to indirectly reconstruct the shape of a solid is through heat transfer models and temperature measurements \cite{alifanov2012inverse} (eg. \cite{zhou2017shape,chen2011inverse,wang2018boundary}).  
...
\ack{CMS acknowledges Intel for funding. GF acknowledges ARMI for funding. Thanks Brian Wood for helpful discussions about the possibility to infer the precise shape of the solid in the tank by tilting it and Adrian Henle for comments on the text.}
